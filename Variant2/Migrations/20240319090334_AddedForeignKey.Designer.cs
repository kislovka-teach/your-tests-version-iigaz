...
namespace Variant2.Migrations
{
    ...
    [Migration("20240319090334_AddedForeignKey")]
            ...
            modelBuilder.Entity("Variant2.Models.Revision", b =>
                {
                    ...
                    b.HasIndex("PreviousRevisionId")
                        .IsUnique()
                        .HasDatabaseName("ix_revisions_previous_revision_id");
            ...
            modelBuilder.Entity("Variant2.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Login = "ivanko",
                            PasswordHash = "GplPIyyrD+GRMKuEKXfuAA==.2fs4Z3cj5iVkXKURST4Q97XTUWu/WBKMQ5g63R04gxI="
                        });
                });
            ...
            modelBuilder.Entity("Variant2.Models.Revision", b =>
                {
                    ...
                    b.HasOne("Variant2.Models.Revision", "PreviousRevision")
                        ...
                        .HasForeignKey("Variant2.Models.Revision", "PreviousRevisionId")
                        .HasConstraintName("fk_revisions_revisions_previous_revision_id");
